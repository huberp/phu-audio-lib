...
{
    // Off-diagonal blocks: port-1 KCL influenced by port-2 voltage and vice versa.
    if (nodeP1 > 0 && nodeP2 > 0) G_mat[(nodeP1-1)*size + (nodeP2-1)] += Gm;
    if (nodeP1 > 0 && nodeN2 > 0) G_mat[(nodeP1-1)*size + (nodeN2-1)] -= Gm;
    if (nodeN1 > 0 && nodeP2 > 0) G_mat[(nodeN1-1)*size + (nodeP2-1)] -= Gm;
    if (nodeN1 > 0 && nodeN2 > 0) G_mat[(nodeN1-1)*size + (nodeN2-1)] += Gm;

    if (nodeP2 > 0 && nodeP1 > 0) G_mat[(nodeP2-1)*size + (nodeP1-1)] += Gm;
    if (nodeP2 > 0 && nodeN1 > 0) G_mat[(nodeP2-1)*size + (nodeN1-1)] -= Gm;
    if (nodeN2 > 0 && nodeP1 > 0) G_mat[(nodeN2-1)*size + (nodeP1-1)] -= Gm;
    if (nodeN2 > 0 && nodeN1 > 0) G_mat[(nodeN2-1)*size + (nodeN1-1)] += Gm;
}
