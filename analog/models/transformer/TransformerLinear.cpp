...
// In case M_PI is not defined by cmath, define it here.  We only need it for
// the filter coefficient calculations, so this is sufficient and avoids any
// issues with non-standard extensions.
#ifndef M_PI
