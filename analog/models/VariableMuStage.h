...
#include "../nonlinear/NR.h"
#include "../nonlinear/TriodeKoren.h"
...
struct VariableMuStageConfig {
    ...
    Analog::Nonlinear::TubeParams tube;
...
private:
    ...
    Analog::Circuit::CapacitorCompanion capK_;

    /// Newton-Raphson iteration manager (constructed once from cfg_.nr).
    Analog::Nonlinear::NRPolicy<2> nr_;
